jQuery(function($) {
    ...
    if(ua.indexOf('Trident') !== -1) {
      $('#recruitment .sizes').each(function() {
        var objElement = $(this);
    ...
    $(window).on('load', function(){     
      $(window).scroll(function () {
        $('#recruitment .js-fadein').each(function () {
    ...
    $(function(){
      $('.scroll').click(function(event){event.preventDefault();
        ...
        var target_top = target_offset.top;$('html, body').animate({scrollTop:target_top}, 500, 'swing');return false;});
    });
